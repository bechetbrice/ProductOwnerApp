...
/**
 * StoryOutcomeBadge - Badge visuel pour afficher l'outcome d'une User Story
 * Identique au TaskOutcomeBadge mais avec un nom distinct pour la cohérence
 */
const StoryOutcomeBadge = ({ outcome, size = 'normal', showLabel = true, className = '' }) => {
...
export default StoryOutcomeBadge;
